...
<html>
    <head>
        ...
        <title>Acountant----------- Student Fee Add</title>
        <style type="text/css">
            body{
...
%>
                                    <form action="StuFeeAddServlet" method="post" name="frm">
                                        <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                            ...
                                            <tr style="background-color: #ccffcc;">
                                                ...
                                                <td>
                                                    <select style="width:100px;" name="sid">
                                                        <option value="">Select ID</option>
                                                        <%
                                                                    DbConnection db = null;
                                                                    try {
                                                                        db = new DbConnection();
                                                                        db.rst = db.stmt.executeQuery("select sid from stu_mstr ");
                                                                        while (db.rst.next()) {
                                                        %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="radio" name="status" value="paid" />Paid&nbsp;<input type="radio" name="status" value="due" />Due
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="pdate" name="idate" onclick="scwShow(this,event);" onfocus="scwShow(this,event);"/>
                                                </td>
                                            </tr>
