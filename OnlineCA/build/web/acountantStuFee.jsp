...
<html>
    <head>
        ...
        <title>Acountant----------- List of Student Fee List</title>
        <style type="text/css">
            body{
                                    ...
                                    <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                        ...
                                        <%
                                                    try {
                                                        ...
                                                        db.rst = db.stmt.executeQuery("SELECT  stu_mstr.sid , stu_mstr.sname , stu_fee.fee , stu_fee.paid , stu_fee.paid_date , stu_fee.due_date FROM onlineca.stu_fee INNER JOIN onlineca.stu_mstr ON (stu_fee.sid = stu_mstr.sid);");
                                                        if (db.rst.next()) {
                                        %>
                                        <tr style="background-color: #f7f7f7;">
                                             <td><a href="acountantStuByID.jsp?sid=<%=db.rst.getString(1)%>" target="_blank"><%=db.rst.getString(1)%></a></td>
