                                    ...
                                    <div id="menu">
                                        ...
                                        <ul>
                                           ...
                                           <li><a href="#"><span>&nbsp;</span></a></li>
                                            ...
                                            <li><a href="adminViewEmpList.jsp"><span>Employee List</span></a></li>
                                           <li><a href="#"><span>&nbsp;</span></a></li>
                                            <li><a href="adminAddTo.jsp"><span>Add To</span></a></li>
                                            <li><a href="adminViewToList.jsp"><span>TO List</span></a></li>

                                           <li><a href="#"><span>&nbsp;</span></a></li>
                                            <li><a href="adminAddActnt.jsp"><span>Add Acountant</span></a></li>
                                            <li><a href="adminViewActntList.jsp"><span>Acountant List</span></a></li>
...
%>
                                    <form action="AdminClientUpldServlet" method="post" name="frm" enctype="multipart/form-data">
                                                ...
                                                <td>
                                                    <select style="width:100px;" name="cid">
                                                        ...
                                                        <%
                                                                    ...
                                                                    try {
                                                                        db = new DbConnection();
                                                                        db.rst = db.stmt.executeQuery("select cid from cust_mstr ");
                                                                        while (db.rst.next()) {
                                                        %>
