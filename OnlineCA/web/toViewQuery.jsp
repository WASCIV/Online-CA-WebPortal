...
<html>
    <head>
        ...
        <title>Training Officer----------- Home</title>
        <style type="text/css">
            body{
                        ...
                        <tr>
                            <td width="950px" bgcolor="#296dc1" height="30px" >
                                ...
                                <div style="font-size: 16px;color: #ffffff; float: left">
                                    <b>    Welcome Student!   <%=toname%></b>
                                </div>
                                <div style="font-size: 16px;color: #ffffff; float: right">
                                    <b>   <a href="ToLogOut" style="text-decoration: none;color: #ffffff;">Log Out&nbsp;&nbsp;</a></b>
                                </div>
                            ...
                            <td width="950px"  valign="top">
                                ...
                                <div style="width: 200px; float: left;background-color: #f7f7f7">
                                    <div id="menu">
                                        ...
                                        <ul>
                                            <li><a href="toHome.jsp"><span>Home</span></a></li>
                                            <li><a href="toViewQuery.jsp"><span>View Query</span></a></li>
                                            <li><a href="toCrateSchedule.jsp"><span>Create Schedule</span></a></li>
                                       ...
                                       <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                        ...
                                        <%
                                                    try {
                                                        ...
                                                        db.rst = db.stmt.executeQuery("select * from stu_query where replied=0");
                                                        while(db.rst.next()) {
                                        %>
                                        <tr style="background-color: #f7f7f7;">
                                            ...
                                            <td><a href="toReplyQuery.jsp?sqid=<%=db.rst.getString(2)%>&sid=<%=db.rst.getString(2)%>&sub=<%=db.rst.getString(3)%>">Reply</a></td>
