                                ...
                                <div style="width: 750px;height: 250px; float: left;">
                                    ...
                                    <%
                                                try {
                                                    ...
                                                    db.rst = db.stmt.executeQuery("select sub, dwnld from cust_dwnld limit 0,5");
                                                     while (db.rst.next()) {
                                    %>
                                    <a href="<%=db.rst.getString(2)%>" style="color: #00cc00;text-decoration: none;"><%=db.rst.getString(1)%></a><br>
