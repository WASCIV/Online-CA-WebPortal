...
public class AddToServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            db.pstmt = db.con.prepareStatement("INSERT INTO to_mstr(toname,tofname,dob,addres,phone,doj,email,login, pswd) VALUES (?,?,?,?,?,?,?,?,?);");
            ...
            db.pstmt.setString(5, ephone);
             db.pstmt.setString(6, edoj);
            db.pstmt.setString(7, eemail);
            ...
            if (j > 0) {
                response.sendRedirect("adminAddTo.jsp?msg=Added Successfully !");
            } else {
                response.sendRedirect("adminAddTo.jsp?msg=Failed !");
            }
